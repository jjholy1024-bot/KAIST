...
**근거 자료**:
- Fang, C.M., Liu, A.R., Danry, V., Lee, E., Chan, S.W.T., Pataranutaporn, P., Maes, P., Phang, J., Lampe, M., Ahmad, L., Agarwal, S. (2025). *How AI and Human Behaviors Shape Psychosocial Effects of Extended Chatbot Use: A Longitudinal Randomized Controlled Study.* MIT Media Lab & OpenAI. arXiv:2503.17473
...
- International AI Safety Report 2026 (국제 AI 안전보고서, 공식 PDF)

> 본 자료는 981명 대상 4주간 무작위 대조 실험(RCT)·30만 건 이상의 대화 데이터를 분석한 MIT-OpenAI 공동 연구, 그리고 International AI Safety Report 2026에서 직접 발췌한 그림·본문을 결합하여, 제안서의 예견된 실패·원인진단·대응방안 각 부분에 대응하는 실증 데이터를 정리한 것입니다.
...
### 2-5. Figure 2.16 — 인간 자율성의 구조 (원문, International AI Safety Report 2026)
...
### 2-6. Box 2.6 — "AI Companions" (원문, International AI Safety Report 2026)
...
### 2-7. Figure 2.18 — AI 컴패니언 이용 동기 설문 (한국어 재구성본)
...
| 역량 저하 그래프 | 대응방안 — AI 의탁이 인간 역량을 약화시키는 메커니즘 |
...
— 각국 정부가 지명한 AI 전문가들이 참여해 작성한 국제 공동 보고서로, 제안서에 인용 시 신뢰도가 높은 1차 출처로 활용 가능합니다.
